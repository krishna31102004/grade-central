      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card className="subject-card">
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground">
                Have well-organized study notes that helped you succeed? Share them with other students.
              </p>
              <ul className="text-sm space-y-1 text-muted-foreground">
                <li>• Clear, well-structured notes</li>
          ...
          <Card className="subject-card">
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground">
                Help us expand our past papers collection or contribute detailed solutions.
              </p>
              <ul className="text-sm space-y-1 text-muted-foreground">
                <li>• Missing past papers or mark schemes</li>
                <li>• Detailed step-by-step solutions</li>
                <li>• Alternative solution methods</li>
                <li>• Common mistake explanations</li>
              </ul>
              <Button className="w-full">
                <Upload className="h-4 w-4 mr-2" />
                Submit Papers
